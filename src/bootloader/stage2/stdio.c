...
void putchrcolor(int x, int y, char c, uint8_t color)
{
    g_ScreenBuffer[2 * (y * SCREEN_WIDTH + x)] = c;
...
void putc(char c)
{
    ...
    default:
        putchrcolor(g_ScreenX, g_ScreenY, c, DEFAULT_COLOR);
        g_ScreenX++;
        break;
    }
...
void putcol(uint8_t c)
{
    ...
    default:
        putcolor(g_ScreenX, g_ScreenY, c);
        g_ScreenX++;
        break;
    }

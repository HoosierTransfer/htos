...
_WCRTLINK extern unsigned long int htonl(unsigned long int __hostlong);
_WCRTLINK extern unsigned short int htons(unsigned short int __hostshort);
_WCRTLINK extern unsigned long int ntohl(unsigned long int __netlong);
_WCRTLINK extern unsigned short int ntohs(unsigned short int __netshort);
